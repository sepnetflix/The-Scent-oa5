...
#%#
#%
for i in index.php config.php includes/db.php views/home.php views/layout/header.php views/layout/footer.php views/cart.php controllers/BaseController.php js/main.js ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_1.md
...
for i in includes/SecurityMiddleware.php controllers/ProductController.php models/Cart.php ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_3.md
for i in controllers/AccountController.php controllers/NewsletterController.php controllers/CheckoutController.php  ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_4.md
