...
#%#
#%
for i in index.php config.php includes/db.php views/home.php views/layout/header.php views/layout/footer.php views/cart.php controllers/BaseController.php models/User.php ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_1.md
...
for i in config/auth.php includes/EmailService.php views/account/dashboard.php views/account/order_details.php views/account/orders.php views/account/profile.php views/checkout.php  ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_5.md
